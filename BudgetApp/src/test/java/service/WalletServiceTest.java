...
//        ByteArrayInputStream in = new ByteArrayInputStream(("1" + System.getProperty("line.separator") + newWalletName).getBytes());
    ...
    public void WalletServiceModifyEntryRemoveCategoriesInvalidEntryChoiceShouldComeBackToMainMenuTest() {
        ...
        // Assert
        assertEquals(walletService.getEntryList("wallet").getEntry(0).getCategories().toString(),"[entertainment]");
    }
    @Test
    ...
    public void WalletServiceHndAddEntryWithAmountAndManyCategoriesShouldAddEntryTest() {
        ...
        // Assert
        assertEquals(walletService.getEntryList("wallet").getEntry(0).getAmount(),6);
        assertEquals(walletService.getEntryList("wallet").getEntry(0).getCategories().toString(),"[entertainment, food, friendly exchange]");
    }
