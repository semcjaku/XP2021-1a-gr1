...
public class MenuModifyEntriesTests {
    ...
    public void MenuModifyEntriesExecuteActionsChangeAmountTest() {
        ...
        MenuModifyEntries menuMod = new MenuModifyEntries(in);
        int amount = 2154;
    ...
    @Test
    public void MenuModifyEntriesExecuteActionsSetCyclicIntervalTest() {
        // Arrange
        ...
        // Act
        menuMod.executeActions(5, entry);

        // Assert
        assertTrue(entry.isCyclic());
        assertEquals(13, entry.getCyclicIntervalInDays());
    }

    @Test
    public void MenuModifyEntriesExecuteActionsSetCyclicDayOfMonthTest() {
        // Arrange
        ByteArrayInputStream in = new ByteArrayInputStream(("13").getBytes());
        MenuModifyEntries menuMod = new MenuModifyEntries(in);
        int amount = 2154;
        ...
        // Act
        menuMod.executeActions(6, entry);

        // Assert
        assertTrue(entry.isCyclic());
        assertEquals(13, entry.getCyclicDayOfMonth());
    }
}
